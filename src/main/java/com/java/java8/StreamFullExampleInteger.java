...
public class StreamFullExampleInteger {
    ...
    public static void main(String[] args) {
        ...
        // Sample Employees
        // ============================
        List<EmployeeInt> employees = Arrays.asList(
                new EmployeeInt(1, "John", 60000, "IT"),
                new EmployeeInt(2, "Sara", 45000, "HR"),
                new EmployeeInt(3, "Mike", 80000, "Finance"),
                new EmployeeInt(4, "David", 30000, "IT"),
                new EmployeeInt(5, "Sujane", 35000, "IT")
        );
        ...
        System.out.println("\n=== Sorted By Salary ===");
        employees.stream()
                .sorted(Comparator.comparing(EmployeeInt::getSalary))
                .forEach(System.out::println);
        ...
        System.out.println("\n=== Max Salary ===");
        employees.stream()
                .max(Comparator.comparing(EmployeeInt::getSalary))
                .ifPresent(System.out::println);

        System.out.println("\n=== Min Salary ===");
        employees.stream()
                .min(Comparator.comparing(EmployeeInt::getSalary))
                .ifPresent(System.out::println);
        ...
        // ============================
        System.out.println("\n=== Sum of Salaries ===");
        int sum = employees.stream().mapToInt(EmployeeInt::getSalary).sum();
        System.out.println(sum);

        System.out.println("\n=== Average Salary ===");
        employees.stream()
                .mapToInt(EmployeeInt::getSalary)
                .average()
                .ifPresent(System.out::println);
        ...
        // ============================
        System.out.println("\n=== Group By Department ===");
        Map<String, List<EmployeeInt>> groupByDept =
                employees.stream().collect(Collectors.groupingBy(EmployeeInt::getDepartment));
        ...
        Map<Boolean, List<EmployeeInt>> partition =
        ...
        Map<String, Long> countByDept =
                employees.stream().collect(Collectors.groupingBy(
                        EmployeeInt::getDepartment, Collectors.counting()));
        ...
        Map<String, Double> avgByDept =
                employees.stream().collect(Collectors.groupingBy(
                        ...
                        Collectors.averagingInt(EmployeeInt::getSalary)));
        avgByDept.forEach((dept, avg) -> System.out.println(dept + " -> " + avg));

        System.out.println("\n=== Joining EmployeeInt Names ===");
        ...
        Map<String, List<String>> namesByDept =
                employees.stream().collect(Collectors.groupingBy(
                        EmployeeInt::getDepartment,
                        Collectors.mapping(EmployeeInt::getName, Collectors.toList())
                ));
        ...
        // ============================
        System.out.println("\n=== FlatMap Example ===");
        List<List<EmployeeInt>> nested = Arrays.asList(employees, employees);
        nested.stream()
                .flatMap(List::stream)
                .forEach(System.out::println);
